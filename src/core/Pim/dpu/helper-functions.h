...
/*ToDo: check for assembly implementation of this algorithm*/
...
static void ModMulNoCheckEq(NativeInt* m_value, NativeInt* b_m_value, NativeInt modulus_m_values,NativeInt mu_value,size_t size) {
