...
void ModAddFastEq(int64_t* m_value, int64_t b_m_value, int64_t modulus_m_values) {
    *m_value += b_m_value;
...
*/
void ModAddEq(int64_t* m_value, int64_t* b_m_value, int64_t modulus_m_values, size_t size) {
